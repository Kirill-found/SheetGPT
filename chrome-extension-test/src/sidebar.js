...
function detectCrossSheetQuery(query) {
  ...
  const patterns = [
    ...
    // Pattern 8: из лист9 / из Лист9 (without quotes, sheet name pattern)
    /(?:из|с|from)\s+(лист\d+|sheet\d+)/i,
    // Pattern 9: данные из лист9 (without quotes)
    /данные\s+(?:из|с)\s+(лист\d+|sheet\d+)/i,
  ];
