...
- needs_gpt_analysis = true для:
  * Сложных аналитических вопросов (тренды, прогнозы)
  * Запросов на ДИАГРАММЫ/ГРАФИКИ (построй диаграмму, график, chart)
  * Запросов на ФОРМУЛЫ (добавь формулу, создай колонку с формулой)
  * Запросов на ФОРМАТИРОВАНИЕ (выдели, покрась, условное форматирование)
  * Любых действий с таблицей кроме простых расчётов
