...
If request is unclear, set confidence < 0.6 and explain what's missing."""
    ...
    async def analyze_data(
        ...
        prompt = f"""Analyze this Google Sheets data and provide STRUCTURED, READABLE response with METHODOLOGY.
...
CRITICAL: Response must be STRUCTURED and SCANNABLE. Users hate reading walls of text!

Response format (JSON):
{{
  "summary": "Краткий вывод в 1-2 предложениях (макс 100 символов)",
  "methodology": "🔍 Как я это посчитал: проанализировал колонку X, сравнил значения, выбрал топ по критерию Y",
  "key_findings": [
    "Конкретная находка 1 с цифрами",
    "Конкретная находка 2 с цифрами",
    "Конкретная находка 3 с цифрами"
  ],
  "insights": [
    "💡 Инсайт 1 - короткий и четкий",
    "💡 Инсайт 2 - короткий и четкий"
  ],
  "suggested_actions": [
