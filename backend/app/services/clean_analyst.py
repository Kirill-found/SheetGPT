...
## ⚠️ САМОЕ ВАЖНОЕ ПРАВИЛО (ЧИТАЙ ПЕРВЫМ!)

**При поиске топ-N, максимума, минимума, лучших/худших:**
1. РАССЧИТАЙ метрику для КАЖДОЙ строки (все 42 строки!)
2. ОТСОРТИРУЙ все результаты
3. ТОЛЬКО ПОТОМ выбери топ-N

**ПРИМЕР ГРУБЕЙШЕЙ ОШИБКИ (за такое тебя уволят!):**
- Запрос: "выдели самые прибыльные кампании"
- Ты выделил строки с ROMI 747%, 417%, 1025%
- НО в таблице есть строки с ROMI 2740%, 1369%, 1363% которые ты ПРОПУСТИЛ!
- Пользователь получил НЕВЕРНЫЙ ответ! Это НЕДОПУСТИМО!

**Если выделяешь топ-5, проверь что у ВСЕХ остальных строк метрика НИЖЕ!**
