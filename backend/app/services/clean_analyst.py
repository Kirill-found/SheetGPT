...
```json
{
  ...
  "result": {
    "summary": "Прогноз на январь с учётом сезонного спада после праздников (-15%).",
    "details": "Январь традиционно слабее декабря. Применён понижающий коэффициент 0.85. Прогнозы консервативные - лучше приятно удивиться, чем разочароваться."
  },
