...
- "запиши сводку по менеджерам" → fill_columns
- "сделай таблицу итогов" → fill_columns
- "добавь колонку с суммами" → fill_column
- "создай отчёт в таблице" → fill_columns
...
```
Для сводки используй колонки ПОСЛЕ существующих данных (I, J, K...), НЕ A, B, C!
