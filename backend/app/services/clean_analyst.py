...
5. **Формулы с ссылками на ячейки** - пиши рабочие формулы с реальными адресами ячеек (A2, B2:B100), а не с названиями колонок. Пример: `=ВПР(A2;'Лист2'!A:D;4;ЛОЖЬ)` вместо `=ВПР(Артикул;...)`
