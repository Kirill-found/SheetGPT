...
4. Хочет ПОСЧИТАТЬ и ВСТАВИТЬ результат? → Python (посчитает и предложит вставить)
   "посчитай сумму и вставь", "добавь итоговую строку"
...
{{"action_type": "highlight", "highlight_rows": [2, 5, 8], "highlight_color": {{"red": 1, "green": 0.8, "blue": 0.8}}, "summary": "Выделены строки с отрицательной прибылью"}}
...
write_value (записать значение в ячейку):
{{"action_type": "write_value", "target_cell": "B12", "value": 55790, "summary": "Записано значение 55790 в ячейку B12"}}
...
ПАЛИТРА ЦВЕТОВ
══════════════════════════════════════════════════════════════
Красный (ошибки, минусы): {{"red": 1, "green": 0.7, "blue": 0.7}}
Зелёный (успех, плюсы): {{"red": 0.7, "green": 0.9, "blue": 0.7}}
Жёлтый (внимание): {{"red": 1, "green": 1, "blue": 0.7}}
Синий (информация): {{"red": 0.7, "green": 0.85, "blue": 1}}
Оранжевый (предупреждение): {{"red": 1, "green": 0.85, "blue": 0.7}}
