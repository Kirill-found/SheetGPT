...
Для VLOOKUP используй action_type "vlookup" с указанием колонки:
{{"action_type": "vlookup", "key_column": "Артикул", "value_column": "Октябрь", "summary": "Подтягиваю данные за октябрь по артикулам."}}
"""
