...
🟢 ВАЖНО: Добавляй колонку СПРАВА к существующим данным (не заменяй)!

Пример ответа для VLOOKUP (добавление колонки по ключу):
{{"action_type": "write_data", "merge_by_key": "Артикул", "write_headers": ["Артикул", "Сентябрь"], "write_data": [["СХ_андер_54", 2170], ["СХ_ЯБл_48", 1850]], "summary": "Подтянуты данные за сентябрь. Колонка добавлена справа."}}
"""
