...
- Формат записи: "Строка N: Товар, поле=значение, поле=значение"
- ПРОБЕЛ после "Строка", ПРОБЕЛ после номера, ДВОЕТОЧИЕ
- НИКОГДА не разбивай одну запись на несколько строк!
- Используй запятую для разделения полей в одной строке
...
explanation += "Примеры:\n"
explanation += "Строка 2: Рюкзак, кол-во=12, цена=4999, выручка=59988\n"
explanation += "Строка 3: Пауэрбанк, кол-во=10, цена=2500, выручка=25000\n"
