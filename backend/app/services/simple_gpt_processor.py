...
9. ⚠️ НЕ конвертируй в числа колонки: телефон, phone, id, код, артикул, номер, инн, паспорт, счет - это ТЕКСТ!

⚠️ КРИТИЧНО - ФОРМАТ explanation:
...
ШАБЛОНЫ explanation (СТРОГО СЛЕДУЙ ФОРМАТУ):
