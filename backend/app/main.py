...
# Create FastAPI app with VERSION 6.6.15 - Backend fix for split operations
app = FastAPI(
    title="SheetGPT API",
    version="6.6.15",  # v6.6.15: BACKEND FIX - Split operations now correctly generate structured_data
...
async def startup_event():
    ...
    logger.info("="*60)
    logger.info("SheetGPT API v6.6.15 STARTING - BACKEND FIX: Split operations now correctly generate structured_data")
