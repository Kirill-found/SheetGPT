"""
SheetGPT API Production v6.6.3 - AI Code Executor with custom_context support
...
# Create FastAPI app with VERSION 6.6.3 - AI Code Executor + custom_context
app = FastAPI(
    title="SheetGPT API",
    version="6.6.3",  # AI Code Executor + custom_context for personalized insights
...
async def startup_event():
    ...
    logger.info("="*60)
    logger.info("SheetGPT API v6.6.3 STARTING - AI CODE EXECUTOR + CUSTOM_CONTEXT")
...
async def root():
    ...
    return {
        "name": "SheetGPT API",
        "version": "6.6.3",  # v6.6.3: custom_context + professional insights
        "status": "operational",
        ...
        "features": {
            ...
            "methodology": True,
            "auto_headers": True,
            "custom_context": True,  # v6.6.3: Personalized AI role
            "professional_insights": True  # v6.6.3: AI-generated insights/recommendations
        },
    ...
    try:
        ...
        try:
            ...
            result = executor.process_with_code(
                ...
                custom_context=request.custom_context  # v6.6.3: Pass custom_context to executor
            )
            executor_used = True
        ...
        # Add highlighting data (v6.6.3: CRITICAL for row highlighting)
        ...
        # v6.6.3: Add professional insights from custom_context feature
